...
const PictureCarousel = () => {
  ...
  return (
    <div className="h-[280px] md:h-[480px] w-full flex-col flex items-center md:w-2/3 my-10 self-center">
      ...
      <div className="flex top-4 justify-center py-2">
        {slides.map((slide, slideIdx) => (
          <div
            ...
            className={
              currentIdx === slideIdx
                ? "text-4xl cursor-pointer text-asme-blue-100"
                : "text-asme-blue-600 cursor-pointer text-4xl"
            }
          >
            <RxDotFilled />
          </div>
